...
public class AnalyzeBlock {
	public static void main(String[] args) throws Exception {
		if( args == null || args.length != 4) {
			System.out.println("usage: java "+AnalyzeBlock.class.getName()+" <database> <class> <tablespace> <block>");
			System.exit(1);
		}
		...
		System.out.printf("--Raw Block: %s%n",btk.getBlockAccessIndex().getBlk());
	}
}
